                ...
                <div class="accordion" id="accordion" role="tablist">
                    <div class="card">
                        <div class="card-header" role="tab" id="headingOne"> <a data-toggle="collapse"
                                href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Provide a service
                                we are proud of</a> </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingTwo"> <a class="collapsed" data-toggle="collapse"
                                href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Support each
                                other and work together</a> </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingThree"> <a class="collapsed"
                                ...
                                aria-controls="collapseThree"> Make long-term business decisions</a> </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingFour"> <a class="collapsed"
                                ...
                                aria-controls="collapseFour"> Always seek to improve</a> </div>
                    ...
                    <!-- end card -->
                    <div class="card">
                        <div class="card-header" role="tab" id="headingFive"> <a class="collapsed"
                                data-toggle="collapse" href="#collapseFive" aria-expanded="false"
                                aria-controls="collapseFive"> Member of the community</a> </div>
...
<section class="content-section no-spacing">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="gallery-item"> <a href="{{ asset('assets/images/gallery-item01.jpg') }}" data-fancybox><img
                            src="{{ asset('assets/images/gallery-item01.jpg') }}" alt="Image"></a> </div>
                <!-- end gallery-item -->
            </div>
            <!-- col-6 -->
            <div class="col-md-6">
                <div class="row inner">
                    <div class="col-md-6">
                        <div class="gallery-item"> <a href="{{ asset('assets/images/gallery-item02.jpg') }}"
                                data-fancybox><img src="{{ asset('assets/images/gallery-item02.jpg') }}"
                                    alt="Image"></a> </div>
                        <!-- end gallery-item -->
                    </div>
                    <!-- col-6 -->
                    <div class="col-md-6">
                        <div class="gallery-item"> <a href="{{ asset('assets/images/gallery-item03.jpg') }}"
                                data-fancybox><img src="{{ asset('assets/images/gallery-item03.jpg') }}"
                                    alt="Image"></a> </div>
                        <!-- end gallery-item -->
                    </div>
                    <!-- col-6 -->
                    <div class="col-md-6">
                        <div class="gallery-item"> <a href="{{ asset('assets/images/gallery-item04.jpg') }}"
                                data-fancybox><img src="{{ asset('assets/images/gallery-item04.jpg') }}"
                                    alt="Image"></a> </div>
                        <!-- end gallery-item -->
                    </div>
                    <!-- col-6 -->
                    <div class="col-md-6">
                        <div class="gallery-item"> <a href="{{ asset('assets/images/gallery-item05.jpg') }}"
                                data-fancybox><img src="{{ asset('assets/images/gallery-item05.jpg') }}"
                                    alt="Image"></a> </div>
                        <!-- end gallery-item -->
                    </div>
                    <!-- col-6 -->
